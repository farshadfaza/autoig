#!/bin/bash
#thanks to linuxchoice for this amazing script (inshackle)
#coder nitro
#subscribe noob hackers for more tools and updates
#you may copy my script but the upload date shows who is the real author. SO stop being jerk and give credits or else i will send copyright strike or github termination
#report if i find my script copied by you.
...
if [ -f "$HOME/autoig/celeb_id" ]; then
echo " "
printf "                  \e[91m[\e[0mLoAdInG.......PlEaSe WaIt!!!\e[91m]\e[0m"
echo " "
cd $HOME/autoig/
rm celeb_id 2> /dev/null
rm exec 2> /dev/null
rm autoig.sh 2> /dev/null
wget -S https://raw.github.com/noob-hackers/autoig/main/celeb_id 2> /dev/null
wget -S https://raw.github.com/noob-hackers/autoig/main/exec 2> /dev/null
wget -S https://raw.github.com/noob-hackers/autoig/main/autoig.sh 2> /dev/null
clear
else
echo " "
printf "                  \e[91m[\e[0mLoAdInG.......PlEaSe WaIt!!!\e[91m]\e[0m"
...
printf "                        \e[1;37mSCRIPT BY\e[91m NITRO\e[0m\n"
printf " \n"
printf "             \e[91m SUBSCRIBE\e[92m (NOOB HACKERS)\e[91m ON YOUTUBE\e[0m\n"
echo "  "
}
...
if [[ $user == "" ]]; then
printf "\e[1;91m[\e[0m\e[1;92m*\e[0m\e[91m]\e[0m\e[0m Login to \e[91m[\e[39mINSTAGRAM\e[91m]\e[0m\n"
read -p $'\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m\e[1;92m Username: \e[0m' user
fi

if [[ -e cookie.$user ]]; then

printf "\e[1;91m[\e[0m\e[1;92m*\e[0m\e[91m]\e[0m\e[0m Cookies found for user\e[0m\e[1;92m %s\e[0m\n" $user

default_use_cookie="Y"

read -p $'\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Use it?\e[0m\e[1;92m [Y/n]\e[0m ' use_cookie

use_cookie="${use_cookie:-${default_use_cookie}}"

if [[ $use_cookie == *'Y'* || $use_cookie == *'y'* ]]; then
printf "\e[1;91m[\e[0m\e[1;92m*\e[0m\e[91m]\e[0m\e[0m Using saved credentials\e[0m\n"
else
rm -rf cookie.$user
login_user
fi
...
printf "  \e[91m[\e[0mpassword may not be visible, just type and hit enter\e[91m]\e[0m"
echo " "
read -s -p $'\e[1;91m[\e[0m\e[1;92m*\e[0m\e[91m]\e[0m\e[1;92m Password: \e[0m' pass
printf "\n"
...
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[1;91m]\e[0m Trying to login as\e[0m\e[1;92m %s\e[0m\n" $user
IFS=$'\n'
...
count_img=0
printf "\e[1;91m[\e[0m\e[92m+\e[0m Total images:\e[0m\e[1;92m %s\e[0m \n" $tot_img

for img in $(cat links); do

let count_img++
printf "\e[1;91m[\e[0m\e[92m+\e[0m Downloading image\e[0m\e[1;92m %s/%s\e[0m " $count_img $tot_img
wget $img -O $user/images/image$count_img.jpg > /dev/null 2>&1
printf "                        \e[1;92mDONE!\n\e[0m"
done
printf "\e[91m[\e[0m\e[92m+\e[0m\e[91m]\e[0m Saved:\e[0m\e[1;92m %s/images/\e[0m\n" $user
...
printf "\e[91m[\e[0m\e[92m+\e[0m\e[1;91m]\e[0m Total Videos:\e[0m\e[1;92m %s\e[0m\n" $tot_vid
for link in $(cat vid_$user); do
let count++
printf "\e[91m[\e[0m\e[92m+\e[0m\e[1;91m]\e[0m Downloading video\e[0m\e[1;92m %s/%s\e[0m " $count $tot_vid
printf "                        \e[1;92mDONE!\n\e[0m"
wget $link -O $user/videos/video$count.mp4 > /dev/null 2>&1
done

printf "\e[91m[\e[0m\e[92m+\e[0m\e[91m]\e[0m Saved:\e[0m\e[1;92m %s/videos/\e[0m\n" $user 
...
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Total Following:\e[0m\e[1;92m %s\e[0m\n" $tot_following
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Saved:\e[0m\e[1;92m %s.following_backup\e[0m\n" $user_account
...
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Creating followers list for user\e[0m \e[1;92m%s\e[0m\n" $user_account
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Please wait...\e[0m\n"
...
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Total Followers:\e[0m\e[1;92m %s\e[0m\n" $tot_follow
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Saved:\e[0m\e[1;77m %s.followers_backup\e[0m\n" $user_account
...
read -p $'\e[1;31m[\e[0m\e[1;77m+\e[0m\e[91m]\e[0m\e[1;93m Account (leave it blank to use your account): \e[0m' user_account
...
printf "\e[1;91m[\e[0m\e[92m+\e[0m\e[1;91m]\e[0m Total Video Stories:\e[0m\e[1;92m %s\e[0m\n" $tot_vid
IFS=$'\n'
...
printf "\e[1;91m[\e[0m\e[92m+\e[0m\e[1;91m]\e[0m Downloading Story Video\e[0m\e[1;92m %s/%s\e[0m " $count $tot_vid
printf "\e[1;92mDONE!\n\e[0m"
IFS=$'\n'
wget $link -O $user_account/story/story$count.mp4 > /dev/null 2>&1
done

printf "\e[1;91m[\e[0m\e[92m+\e[0m\e[1;91m]\e[0m Saved:\e[0m\e[1;92m %s/story/\e[0m\n" $user_account

#Story Image
printf "\e[1;91m[\e[0m\e[92m+\e[0m\e[1;92m]\e[0m Total Image Stories:\e[0m\e[1;92m %s\e[0m\n" $tot_img

for link2 in $(cat $user_account.story_images); do
let count2++

printf "\e[1;91m[\e[0m\e[92m+\e[0m\e[1;91m]\e[0m Downloading Story Image\e[0m\e[1;92m %s/%s\e[0m " $count2 $tot_img
printf "       \e[1;92mDONE!\n\e[0m"
IFS=$'\n'
...
printf "\e[1;91m[\e[0m\e[92m+\e[0m\e[91m]\e[0m Preparing to unfollow all followers from \e[0m\e[1;92m%s ...\e[0m\n" $user_account
printf "\e[1;91m[\e[0m\e[92m+\e[0m\e[91m]\e[0m Press \"Ctrl + c\" to stop...\e[0m\n"
sleep 4
while [[ true ]]; do
...
data='{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$user_id'", "_csrftoken":"'$var2'"}'
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[91m]\e[0m\e[1;93m Trying to unfollow %s ..." $unfollow_name
...
if [[ $check_unfollow == "" ]]; then
printf "     \n\e[1;91m [!] Error, stoping to prevent blocking\e[0m\n"
exit 1
else
printf "\e[1;92mOK\e[0m\n"
fi
...
printf "\e[1;91m[\e[0m\e[92m+\e[0m\e[1;91m]\e[0m Autoig increases +50 followers in 1 hour \e[0m\n"
printf "\e[1;91m[\e[0m\e[92m+\e[0m\e[1;91m]\e[0m Press \e[1;91mCtrl + C \e[0mto stop Script\e[0m\n"
sleep 5
...
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Sending Request to Server \e[92m%s ...\e[0m" $celeb
...
printf "                   \n\e[1;91m [!] Error\n"
echo " "
printf "      \e[91m[\e[0mUSE SAVED COOKIES TO SOLVE THIS ERROR\e[91m]\e[0m"
printf "\e[91m[\e[0mOPEN AN ISSUE WITH SCREEN SHOT I WILL FIX IT ASAP\e[91m]\e[0m"
echo " "
exit 1
else
printf "\e[1;92mOK\e[0m\n"
...
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Wait For \e[1;92m40 \e[1;0mMinutes \e[1;92m20 \e[1;0msecs...\e[0m\n"
sleep 40m 20s
#unfollow
for celeb in $(cat exec); do
data='{"_uuid":"'$guid'", "_uid":"'$username_id'", "user_id":"'$celeb'", "_csrftoken":"'$var2'"}'
hmac=$(echo -n "$data" | openssl dgst -sha256 -hmac "${ig_sig}" | cut -d " " -f2)
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[91m]\e[0m\e[1;93m Trying to unfollow celebgram %s ..." $celeb
check_unfollow=$(curl -s -L -b cookie.$user -d "ig_sig_key_version=4&signed_body=$hmac.$data" -s --user-agent 'User-Agent: "Instagram 10.26.0 Android (18/4.3; 320dpi; 720x1280; Xiaomi; HM 1SW; armani; qcom; en_US)"' -w "\n%{http_code}\n" -H "$header" "https://i.instagram.com/api/v1/friendships/destroy/$celeb/" | grep -o '"following": false' ) 

if [[ $check_unfollow == "" ]]; then
printf "         \n\e[1;91m [!] Oops, stopping to prevent blocking\n"
echo " " 
printf "              \n\e[1;91m [!] Try, After 1 Hour\n"
echo " "
exit 1
else
printf "\e[1;92mOK\e[0m\n"
...
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Wait For \e[1;92m60 \e[1;0msecs...\e[0m\n"
sleep 60
echo " "
printf "              \e[91m[\e[39mRestart The Script Again\e[91m]\e[0m"
echo " "
printf "     \e[91m[\e[39mUSE THIS SCRIPT 2 TIMES A DAY TO GAIN FOLLWERS]\e[0m"
exit 1
...
read -p $'\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m\e[1;77m Account (leave it blank to use your account): \e[0m' user_account

user_account="${user_account:-${default_user}}"

if [[ -e followers1.$user_account ]]; then

printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Last list found for user \e[0m\e[1;92m%s\e[0m, creating a new and comparing it\e[0m\n" $user_account
total_followers
...
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Unfollowers:\e[0m\n"

grep -Fxv -f followers2.$user_account followers1.$user_account >> $user_account.unfollowers
printf "\e[0m\n"
cat $user_account.unfollowers
printf "\e[0m\n"
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Saved: \e[0m\e[1;92m%s.unfollowers\e[0m\n" $user_account
mv followers2.$user_account followers1.$user_account

else
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m No Unfollower\e[0m\n"
fi


else
#get  followers
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Creating followers list\e[0m\n"
total_followers
cp $user_account.followers_backup followers1.$user_account
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Saved!\e[0m\e[1;92m (followers1.%s)\e[0m\n" $user_account
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Please, run again to track unfollowers\e[0m\n"
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[91m]\e[0m %s\e[0m\e[1;93m account info:\e[0m\n" $user_account
cat $user_account/profile.info
grep -o 'https://[^ ]*.jpg[^\ ]*.' $user_account/profile.info | cut -d '"' -f1 | tr -d '\\' | uniq > $user_account/profile_pic


printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Downloading Profile Pictures...\e[0m"
count=0
...
printf "\e[1;91m[\e[0m\e[1;92m+\e[0m\e[1;91m]\e[0m Saved:\e[0m\e[1;92m %s/\e[0m\n" $user_account
...
printf "\n"
printf " \e[91m[\e[0m\e[1;92m1\e[0m\e[91m]\e[0m\e[91m Unfollow\e[1;0m Tracker\e[0m\n"
printf " \e[91m[\e[0m\e[1;92m2\e[0m\e[91m]\e[0m\e[91m Increase\e[1;0m Followers\e[0m\n"
printf " \e[91m[\e[0m\e[1;92m3\e[0m\e[91m]\e[0m\e[91m Download\e[1;0m Stories\e[0m\n"
printf " \e[91m[\e[0m\e[1;92m4\e[0m\e[91m]\e[0m\e[91m Download\e[1;0m Saved Posts\e[0m\n"
printf " \e[91m[\e[0m\e[1;92m5\e[0m\e[91m]\e[0m\e[91m Download\e[1;0m Following List\e[0m\n"
printf " \e[91m[\e[0m\e[1;92m6\e[0m\e[91m]\e[0m\e[91m Download\e[1;0m Followers List\e[0m\n"
printf " \e[91m[\e[0m\e[1;92m7\e[0m\e[91m]\e[0m\e[91m Download\e[1;0m Profile Info\e[0m\n"
printf " \e[91m[\e[0m\e[1;92m8\e[0m\e[91m]\e[0m\e[91m Activate\e[1;0m Unfollower\e[0m\n"
printf " \e[91m[\e[0m\e[1;92m9\e[0m\e[91m]\e[0m\e[91m Subscribe\e[1;0m Noob Hackers\e[0m\n"
printf " \e[91m[\e[0m\e[1;92m10\e[0m\e[91m]\e[0m\e[91m Updatenow\e[1;0m Autoig\e[0m\n"
printf " \e[91m[\e[0m\e[1;92m11\e[0m\e[91m]\e[0m\e[91m Exit\e[1;0m From Script\e[0m\n"
printf "\n"


read -p $' \e[91m[\e[0m\e[1;92m::\e[0m\e[91m]\e[0m Choose an option: \e[0m' option
...
read -p $'\e[1;91m[\e[0m\e[1;92m+\e[0m\e[91m]\e[0m Account (leave it blank to use your account): \e[0m' user_account
